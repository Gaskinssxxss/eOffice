    ...
    <div class="flex justify-center items-center h-screen text-center">
      <div class="space-y-4">
        <div class="flex justify-start space-x-2 items-center">
          ...
          <h1 class="font-Public font-bold text-3xl text-blue-500 uppercase">
            Suggest
          </h1>
        </div>
        <h1
          class="font-Public font-semibold text-xs uppercase text-gray-600 text-justify"
        >
          Buka Sistem ini dengan device berukuran mempuni (Laptop, Komputer)
          untuk mendapatkan user exprieince yang lebih baik.
        </h1>
        <h1
          class="font-Public font-semibold text-xs uppercase text-gray-600 text-justify"
        >
